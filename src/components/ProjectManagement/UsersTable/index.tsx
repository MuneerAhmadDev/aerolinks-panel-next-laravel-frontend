...
const rows = [
  ...
  createData(
    ...
    "Rebecca Block",
    "Rebecca@aerolinks.com",
    "QA Tester",
    "Product Development, Aerolinks Dashboard Design",
    "deactive"
  ),
  createData(
    "#849",
              ...
              <TableBody>
                {(rowsPerPage > 0
                  ...
                  <TableRow key={row.id}>
                    ...
                    >
                      <Box
                        className={`Aerolinks-badge ${row.status}`}
                  ...
                  <Grid item xs={12} md={12} lg={6}>
                    ...
                    <FormControl fullWidth>
                      ...
                      >
                        ...
                        <MenuItem value={9}>Aerolinks Dashboard</MenuItem>
                      </Select>
                    </FormControl>
                  </Grid>
